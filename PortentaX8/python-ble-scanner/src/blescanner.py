...
nicla_sense_mac = os.getenv("NICLA_SENSE_MAC")
...
nicla_vision_mac = os.getenv("NICLA_VISION_MAC")
#Monitored characteristics
...
while True:
    ...
    with InfluxDBClient(url="http://x8-host:8086", token=token, org=org) as client:
